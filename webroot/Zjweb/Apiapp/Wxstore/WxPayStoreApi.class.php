...
use Apiapp\Wxstore\WxPayStoreConfig;
use Apiapp\Wxstore\WxPayUnifiedOrder;
use Apiapp\Wxstore\WxPayResults;
...
class WxPayStoreApi
{
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        if(!$inputObj->IsNotify_urlSet()){
            $inputObj->SetNotify_url(WxPayStoreConfig::NOTIFY_URL);//异步通知url
        }

        $inputObj->SetAppid(WxPayStoreConfig::APPID);//公众账号ID
        $inputObj->SetMch_id(WxPayStoreConfig::MCHID);//商户号
