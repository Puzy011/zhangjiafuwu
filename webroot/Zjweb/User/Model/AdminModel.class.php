...
class AdminModel extends Model{
	...
	protected $_auto = array(
		...
		array('proid', 0, self::MODEL_INSERT),
		array('cityid', 0, self::MODEL_INSERT),
		array('telephone', "", self::MODEL_INSERT),
		array('address', "", self::MODEL_INSERT),
		array('cellphone', "", self::MODEL_INSERT),
		array('contact', "", self::MODEL_INSERT),
		array('status', '0'),
	);
