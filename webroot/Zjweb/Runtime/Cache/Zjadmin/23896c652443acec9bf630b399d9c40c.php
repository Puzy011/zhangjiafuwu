...
<head>
    <meta charset="UTF-8">
    <title>欢迎您登掌家</title>
    <link rel="stylesheet" type="text/css" href="/Public/Zjadmin/css/login.css" media="all">
</head>
<body id="login-page">
<div id="main-content">
    ...
    <div class="login-body">
        <div class="login-main pr">
            <form action="<?php echo U('login');?>" method="post" class="login-form">
                <h3 class="welcome"><!--<i class="login-logo"></i>-->掌家管理平台</h3>
                ...
                <div class="login_btn_panel">
                    <button class="login-btn" type="submit">
                        ...
                        <span class="on"><img src="/Public/Zjadmin/images/open.png" class="floating-btn" ></span>
                    </button>
